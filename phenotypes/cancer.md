...
- **Transcript-activated chromatin shredding (RNA-guided cell ablation)** — an emerging route to **undruggable driver mutations**: instead of drugging or restoring the mutant protein, deliver an RNA-guided nuclease ([[methods/cas12a2-trans-cleavage|Cas12a2]]) programmed against a cancer-specific transcript, so any cell expressing it self-destructs via collateral chromatin shredding. Doudna lab (*Nature* 2026) selectively killed cells bearing mutant *TP53* (R248Q + others), *EGFR* exon-19 deletions, and amplified *CCNE1*/*MYC*; LNP mRNA delivery reduced tumour burden in mice (but failed against advanced established tumours) [^zeng2026cancer]. The strategy **kills** mutant-p53 cells rather than reactivating p53 — sidestepping the concern that p53 *activation* in healthy cells can induce senescence (the [[p53]] aging trade-off, § *The p53 trade-off* above). Preclinical; delivery-limited. See [[transcript-activated-cell-ablation]] · [[studies/zeng-2026-cas12a2-chromatin-shredding]]. #gap/needs-human-replication
...
[^zeng2026cancer]: [[studies/zeng-2026-cas12a2-chromatin-shredding]] · doi:10.1038/s41586-026-10738-7 (*Nature* 2026; preprint doi:10.64898/2026.05.08.723607) · Zeng J, …, Doudna JA · in-vitro (human cell lines) + in-vivo (mouse: MYC liver GEMM; PC9 lung xenografts) · transcript-activated chromatin shredding via SuCas12a2 collateral cleavage; selective killing by mutant *TP53* / *EGFR*-deletion / oncogene-abundance transcripts; LNP mRNA+gRNA reduced liver-tumour surface area + delayed lung metastasis; advanced established tumours not cleared. Open-access preprint (CC-BY); Nature version paywalled.
