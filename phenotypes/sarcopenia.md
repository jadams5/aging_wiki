...
| Senolytics ([[fisetin]], dasatinib + quercetin) | Senescent cell clearance — clears both resting aged-niche senescent cells and **load-induced senescent cells** generated by the hypertrophic stimulus itself; in old mice D+Q rescued blunted overload hypertrophy and improved regeneration [^dungan2022-seno][^moiseeva2023-seno] | Preclinical (mouse); senescent-cell appearance after a single resistance-exercise bout shown in humans but the senolytic rescue is mouse-only; benefit age-specific (aged/clearance-impaired muscle); no human senolytic + resistance-training trial #gap/needs-human-replication |
