...
**Thymic involution is now quantifiable at scale and prognostic for mortality.** Two 2026 *Nature* companion papers trained a deep-learning model to score "thymic health" (size/shape/parenchyma-vs-fat composition) from routine chest CT and showed, in ~27,600 asymptomatic adults, that higher thymic health predicts ~50% lower all-cause and ~63% lower cardiovascular mortality and ~36% lower lung-cancer incidence; in a separate cancer cohort it predicted immunotherapy benefit independent of PD-L1/TMB, and correlated with TCR diversity and TRECs[^bernatzThymicHealth2026]. This is the first population-scale outcome validation that thymic involution — long treated as a benign inert process — is a measurable axis of immune aging. See [[thymic-health-score]] for the biomarker and [[thymus]] for the organ. #gap/no-fulltext-access #gap/needs-replication (single group, 2026, closed-access; not independently replicated)
...
[^bernatzThymicHealth2026]: [[studies/bernatz-2026-thymic-health-adults]] (doi:10.1038/s41586-026-10242-y) + [[studies/bernatz-2026-thymic-health-immunotherapy]] (doi:10.1038/s41586-026-10243-x) · Bernatz S, Aerts HJWL, Birkbak NJ et al. (2026) *Nature* · companion observational imaging papers · deep-learning thymic-health score from chest CT · n≈27,612 (NLST + Framingham) for mortality/incidence + n≈3,476 pan-cancer ICB cohort with TRACERx molecular validation (TCR diversity, TRECs) · ~50% lower all-cause / ~63% lower CV mortality / ~36% lower lung-cancer incidence (high vs low thymic health) · closed-access, no local full text; effect sizes from abstract + secondary coverage, approximate #gap/no-fulltext-access
