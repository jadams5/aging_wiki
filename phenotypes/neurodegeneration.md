...
verified-by: claude
verified-scope: "Hara 2006 (nature04724) and Komatsu 2006 (nature04723): Cre driver, inclusion body type, survival outcome verified against local PDFs. Wong & Cuervo 2010 (nn.2575): all three NDD-specific CMA/autophagy claims verified against local PDF. Bouzid 2023 (s41591-023-02397-2): OR=0.64 and P=3.8e-5 confirmed; n corrected from wrong >47,000 to 5,730 (1,362 AD + 4,368 controls) via published abstract; main text PDF not readable (supplementary file only in archive). van Dyck 2023 (NEJMoa2212948): CDR-SB primary endpoint and ARIA rates verified against local PDF; ARIA-E corrected from wrong ~21% to 12.6%; ARIA-H corrected from wrong ~35% to 17.3%; combined ARIA-E or ARIA-H 21.5% added. Hartl 2011 and Lin & Beal 2006: not_oa, unverifiable — claims are consensus-level. DiSabato 2016: download failed (no PMC URL) — neuroinflammation claims tagged #gap/no-fulltext-access."
---
