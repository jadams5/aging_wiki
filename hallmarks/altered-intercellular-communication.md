...
**Sex hormone axes.** Ovarian senescence at menopause (mean ~51 years in humans) produces abrupt estrogen and progesterone withdrawal; testosterone declines gradually in men ("andropause," ~1–2% per year after age 30). These shifts alter bone density, muscle mass, cardiovascular risk, cognitive function, and immune activation thresholds. HRT effects: see [[interventions/pharmacological/]] — clinical use established; net benefit/risk depends on timing, formulation, and individual risk profile. #gap/unsourced — atomic page for sex hormone biology in aging not yet seeded; downstream cross-references pending.
