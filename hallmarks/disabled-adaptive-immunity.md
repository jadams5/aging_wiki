...
**Thymic involution is now a population-scale prognostic readout.** Two 2026 *Nature* companion papers (Bernatz, Aerts, Birkbak et al.) trained a deep-learning model to score "thymic health" — size/shape/parenchyma-vs-fat composition — from routine chest CT, and showed in ~27,600 asymptomatic adults that higher thymic health predicts ~50% lower all-cause and ~63% lower cardiovascular mortality and ~36% lower lung-cancer incidence [^bernatzAdults2026]. This converts thymic involution from a qualitative mechanistic story into a measurable, hard-endpoint-linked biomarker (see [[thymic-health-score]]), strengthening the case for restoring thymic output as a longevity lever — though the data are observational, not causal. #gap/no-fulltext-access
...
**Host adaptive-immune competence gates the whole Side-B column.** Even where a target is highly immunogenic, augmentation only pays off if the patient still has the adaptive-immune machinery to mount and diversify a response — i.e. residual thymic output and TCR breadth. A 2026 *Nature* paper found that the deep-learning [[thymic-health-score]] predicted **immune-checkpoint-inhibitor benefit in NSCLC independent of PD-L1 and tumor mutational burden** — the two canonical *tumor-side* immunogenicity markers — and correlated with TCR diversity and TRECs [^bernatzImmuno2026]. In other words, thymic health is the **host-side** axis of this table: it sets the ceiling on how much any surveillance-augmenting intervention (checkpoint blockade, neoantigen vaccines, even thymic regeneration) can deliver. This is a concrete clinical handle on the long-standing intuition that immunosenescence blunts cancer immunotherapy. #gap/no-fulltext-access
...
[^bernatzAdults2026]: [[studies/bernatz-2026-thymic-health-adults]] · doi:10.1038/s41586-026-10242-y · Bernatz S, Aerts HJWL, Birkbak NJ et al. (2026) "Thymic health consequences in adults" · *Nature* · observational imaging cohort, n≈27,612 (NLST + Framingham) · deep-learning thymic-health score on chest CT; humans · ~50% lower all-cause / ~63% lower CV mortality / ~36% lower lung-cancer incidence (high vs low) · closed-access, no local full text; effect sizes approximate #gap/no-fulltext-access
[^bernatzImmuno2026]: [[studies/bernatz-2026-thymic-health-immunotherapy]] · doi:10.1038/s41586-026-10243-x · Bernatz S, Aerts HJWL, Birkbak NJ, Awad M, Ricciuti B et al. (2026) "Thymic health and immunotherapy outcomes in patients with cancer" · *Nature* · observational, n≈3,476 pan-cancer immune-checkpoint-inhibitor cohort + TRACERx molecular validation · humans · thymic health predicts NSCLC progression/mortality on ICB independent of PD-L1/TMB; correlates with TCR diversity + TRECs · closed-access, no local full text; HRs not retrieved #gap/no-fulltext-access
