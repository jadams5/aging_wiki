...
**Scope caveat:** This framework is introduced in a Perspective article; the companion SenNet cross-tissue atlas data papers (which quantify specific senotype populations, blood biomarkers, and AI-classifier tools such as SenLect) are being published separately and are not seeded here. See [[studies/suryadevara-2026-senotypes]] for details and future seeding leads. #gap/needs-replication (senotype concept introduced in one Perspective; independent validation of the framework and specific senotype identities awaits primary atlas data and replication).

**Empirical support from contemporaneous Krizhanovsky-lab preprints (Weizmann Institute):** Two independent preprints from the Krizhanovsky laboratory provide quantitative data consistent with the tissue-specificity and functional-heterogeneity predictions of the senotype framework. These are **not** SenNet consortium papers; they represent independent corroboration from a separate research group.
