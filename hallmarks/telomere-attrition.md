...
### Telomeric DDR suppression without telomere elongation

[[telomeric-antisense-oligonucleotides]] target the noncoding telomeric RNAs that help sustain persistent damage-response assemblies at dysfunctional telomeres. In G3 *Terc*−/− mice, a four-week tASO course reduced telomere-dysfunction-induced foci and improved marrow/spleen pathology, HSPC colony formation, and selected immune readouts while telomere length remained unchanged [^oppezzo2026]. Aged wild-type mice showed lower HSPC DDR/p16-associated signals, improved colony formation, and stronger vaccine-binding IgG; human evidence was limited to ex-vivo colony assays from two male donors.

This is evidence that part of the phenotype attributed to short telomeres is mediated by persistent downstream signaling rather than length alone. It is not reversal of telomere attrition. Most mouse endpoints pooled anti-TeloG and anti-TeloC, while only anti-TeloG significantly rescued long-term competitive repopulation when tested separately. Suppressing a tumor-suppressive checkpoint at critically short telomeres also creates a genomic-surveillance risk that the study's limited necropsy and acute irradiation assay cannot resolve. The approach remains preclinical. #gap/needs-replication #gap/needs-human-replication #gap/long-term-unknown
...
Three intervention pages now link here: [[telomerase-activators]], [[interventions/gene-therapy/aav-tert]], and [[telomeric-antisense-oligonucleotides]]. They respectively attempt telomerase activation, TERT delivery/telomere recapping, and downstream tDDR suppression. Only AAV-modTERT has reached an early human trial, in dilated cardiomyopathy rather than aging; tASOs remain preclinical. Intervention tractability therefore remains `low`.
...
- **Checkpoint suppression and cancer**: tASOs avoid telomere elongation but suppress persistent signaling from dysfunctional telomeres. Whether this lets genomically unstable or premalignant clones survive is unknown; sequence-separated efficacy, clonal tracking, cytogenetics, and long-duration tumor surveillance are required. #gap/long-term-unknown
...
[^lopezOtin2013]: doi:10.1016/j.cell.2013.05.039 · López-Otín C, Blasco MA, Partridge L, Serrano M, Kroemer G · review · Cell 2013 · 153(6):1194–1217 · model: conceptual framework · telomere attrition defined as one of 9 primary hallmarks · full text verified

[^harley1990]: doi:10.1038/345458a0 · Harley CB, Futcher AB, Greider CW · in-vitro · Nature 1990 · 345:458–460 · model: human fibroblasts (serial passage) · demonstrates progressive telomere shortening with cell division; foundational quantitative basis for end-replication problem as cause of replicative senescence · not_oa #gap/no-fulltext-access — key quantitative claims (~50–150 bp/division, ~50 doublings) need PDF verification

[^deLange2005]: doi:10.1101/gad.1346005 · de Lange T · review · Genes Dev 2005 · 19(18):2100–2110 · model: human/mammalian · identifies shelterin as 6-protein complex (TRF1, TRF2, POT1, TIN2, TPP1, Rap1) protecting telomeres from DDR; definitive structural description · full text not yet checked #gap/no-fulltext-access

[^celli2005]: doi:10.1038/ncb1275 · Celli GB, de Lange T · in-vitro · Nat Cell Biol 2005 · 7(7):712–718 · model: mouse embryo fibroblasts (MEFs; mixed 129/BL6 background); conditional deletion of *Trf2* via Cre recombinase; TRF2 loss → ATM kinase activation and chromosome-end fusions (NHEJ-dependent) without requiring 3' overhang degradation; TIFs observed in ~50–67% of TRF2-null cells; demonstrates shelterin occupancy, not telomere length, is the proximal DDR signal · full text verified

[^prowsegreider1995]: doi:10.1073/pnas.92.11.4818 · Prowse KR, Greider CW · in-vivo · PNAS 1995 · 92:4818–4822 · model: M. musculus (BALB/c), M. spretus; multiple adult tissues + human somatic tissues · TRAP assay; telomerase detected in testis and liver (both species), kidney and spleen (BALB/c); absent from brain (both species); all M. musculus strains have TRFs at limit-mobility (>30 kb); no detectable telomerase in >50 human somatic tissue samples by TRAP · full text verified

[^cawthon2003]: doi:10.1016/S0140-6736(03)12384-7 · Cawthon RM, Smith KR, O'Brien E, Sivatchenko A, Kerber RA · observational · Lancet 2003 · n=143 individuals >60 years · Southern blot LTL; shorter LTL associated with 3.18× higher heart-disease mortality (95% CI 1.36–7.45) and 8.54× higher infectious-disease mortality (95% CI 1.52–47.9) · not_oa #gap/no-fulltext-access — associations confirmed via published abstract (PMID 12573379); n and CIs confirmed; full HRs/adjustment details not verified against PDF

[^bernardes2012]: doi:10.1002/emmm.201200245 · Bernardes de Jesus B, Vera E, Schneeberger K, Tejera AM, Ayuso E, Bosch F, Blasco MA · in-vivo · EMBO Mol Med 2012 · 4:691–704 · model: >95% C57BL/6 background mice, AAV9-mTert i.v. at 1 yr (eGFP n=12, mTERT n=21, control n=43) or 2 yr (eGFP n=14, mTERT n=23, control n=29) · 24% median lifespan extension (1-yr cohort, p=0.02 Log Rank), 13% (2-yr cohort, p=0.05 Log Rank); improved insulin sensitivity, BMD, neuromuscular coordination; cancer incidence not increased (p=0.87) · full text verified

[^oppezzo2026]: [[studies/oppezzo-2026-telomeric-ddr-hematopoiesis]] · Oppezzo A et al. · doi:10.1038/s43587-026-01136-9 · randomized in-vivo mouse study plus human CD34+ HSPCs ex vivo · G3 *Terc*−/− and aged C57BL/6J mice; human n=2 male donors · tASO suppressed telomeric DDR without telomere elongation; anti-TeloG alone rescued competitive repopulation · *Nature Aging* 2026
