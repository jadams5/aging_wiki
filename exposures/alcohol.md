...
Alcohol intake also has a dedicated methylation readout: the **[[biomarkers/dnam-alcohol-consumption]]** biomarker (DNAm-Alc), a 144-CpG composite whose top locus — hypomethylation at cg06690548 in **SLC7A11** (the cystine/glutamate antiporter) — is the one alcohol-methylation site with validated downstream function (↑SLC7A11 expression in AUD prefrontal cortex + chronic alcohol-fed rat liver; glutathione/ferroptosis + glutamate-signaling consequences). The signature tracks current intake and largely reverts with sustained abstinence.
