...
pmid: 19386744
pmc: PMC2682995
title: "Vitamin K supplementation and progression of coronary artery calcium in older men and women"
authors: [Shea MK, O'Donnell CJ, Hoffmann U, Dallal GE, Dawson-Hughes B, Ordovas JM, Price PA, Williamson MK, Booth SL]
year: 2009
...
hallmarks-tested: ["[[vascular-calcification]]"]
human-evidence: true
peer-reviewed: true
preregistered: false
key-findings: [cac-progression-itt-null, k1-perprotocol-positive, pre-existing-cac-subgroup-positive, single-trial-dominates-meta]
local-pdf: null
verified: true
verified-date: 2026-06-14
verified-by: claude
verified-scope: "Full PDF verified against PMC2682995 (9 pp). All ITT and per-protocol n's, Agatston means, p-values, and MGP findings confirmed against Tables 2–3 and Results text. Design correction applied: per-protocol adherence threshold was pre-specified (predefined), not post-hoc. Control-arm supplement clarified (both arms received calcium 600 mg/d + vitamin D 400 IU/d). Adherent-n discrepancy (abstract n=367 total adherent vs analytical n=295 with all covariates) documented. Canonical-DB identity fields not re-verified."
...
The primary analysis failed to show a significant treatment effect on CAC progression [^shea2009itt].
...
Among the 295 participants meeting the adherence threshold, CAC progression was significantly lower in the vitamin K1 arm [^shea2009pp]. This is the result most cited in downstream reviews. **Readers should note: the ≥85% adherence threshold was predefined (stated as a secondary analysis in the methods), but it was not the pre-registered primary endpoint.** The total number of participants meeting the ≥85% adherence criterion was 367; the analytical n of 295 (149+146) reflects those with all covariate data available for the secondary analysis.
...
The treatment effect was concentrated in participants with pre-existing calcification at baseline — the sub-population where clinically meaningful attenuation would matter most [^shea2009cac].
...
| Page | Relationship |
|---|---|
| [[processes/vascular-calcification]] | Process page discussing CAC biology and the Li 2023 meta-analysis this trial dominates |
...
| [[hallmarks/deregulated-nutrient-sensing]] | Vitamin K-dependent carboxylation intersects with nutrient-sensing hallmark |
...
[^shea2009itt]: doi:10.3945/ajcn.2008.27338 (this page) · n=388 (200 treatment, 188 control) · rct · p=0.26 (NS) · model: healthy older men and postmenopausal women, community-dwelling; Framingham offspring/spouse cohort · ITT primary analysis; full text confirmed via PMC2682995
[^shea2009pp]: doi:10.3945/ajcn.2008.27338 (this page) · n=295 (149 treatment, 146 control; ≥85% adherent) · rct (per-protocol subgroup) · p=0.03 · model: same cohort, adherent participants only; secondary analysis
[^shea2009cac]: doi:10.3945/ajcn.2008.27338 (this page) · n=170 (81 treatment, 89 control; baseline Agatston >10) · rct (exploratory subgroup) · p=0.03 · model: pre-existing CAC enriched; mean Agatston change 25 vs 59 units; exploratory post-hoc analysis
