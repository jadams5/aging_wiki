...
verified-by: claude
verified-scope: "Zhu 2015, Justice 2019, Hickson 2019, Li 2016, and Farr 2024 verified against full primary sources; Farr schedule/design/SASP and Hickson IHC-cell-count labeling are retained. Canonical-database identity fields were not independently re-verified. Gonzales 2023, Garbarino 2025, Liu 2025, and Farr 2025 remain abstract-level additions. Lombardo 2026 main article was verified end-to-end on 2026-08-02 for the D+Q regimen, oligodendrocyte/myelin endpoints, sample/statistical-unit caveat, individual-drug culture results, UPR-association limits, and absent brain senolytic target engagement; supporting information was unavailable."
---
...
Healthy young and aged C57BL/6J mice given D 5 mg/kg + Q 50 mg/kg for six oral doses across four weeks developed thinner myelin in the rostral corpus callosum without detected oligodendrocyte loss. The displayed TEM experiment used three mice/group and tested nested axons rather than reporting a mouse-level effect estimate. In primary rat cultures, quercetin, dasatinib, and D+Q each rapidly retracted mature-oligodendrocyte processes; D+Q also impaired OPC differentiation. Transcriptomics and ATF4/XBP1 staining associated the phenotype with an [[unfolded-protein-response]]-related signature, but no rescue established causality [^lombardo2026]. Only the combination was tested in vivo, and the study did not measure brain senescent-cell burden or target engagement; quercetin-specific attribution and a senolysis mechanism therefore remain unresolved. Quercetin was undetectable in CSF in the small Gonzales 2023 SToMP-AD trial, but that observation neither measures white-matter safety nor resolves the cross-species exposure gap. #gap/needs-replication #gap/needs-human-replication #gap/no-mechanism #gap/long-term-unknown
