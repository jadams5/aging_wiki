...
- Green tea contains multiple bioactive compounds ([[l-theanine|L-theanine]], caffeine, ECG, EGC, EC) — the EGCG-attributable fraction cannot be isolated from observational data.
