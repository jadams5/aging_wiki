...
verified-by: claude
verified-scope: "Zhu 2015, Justice 2019, Hickson 2019, and Farr 2024 verified against full primary sources; Farr schedule/design/SASP and Hickson progenitor/IHC-labeling corrections are retained. PubChem/ChEMBL identifiers were confirmed previously; DrugBank and InChIKey were not independently re-verified. Gonzales 2023, Garbarino 2025, Liu 2025, and Farr 2025 remain abstract-level additions. Lombardo 2026 main article was verified end-to-end on 2026-08-02 for the D+Q regimen, oligodendrocyte/myelin endpoints, sample/statistical-unit caveat, individual-drug culture results, UPR-association limits, and absent brain senolytic target engagement; supporting information was unavailable."
---
...
**Hickson et al. 2019 (DKD, n=9)** [^hickson2019]: Nine subjects (7 male, 2 female; mean age 68.7 ± 1.0 years; eGFR 27.0 ± 0.7 mL/min/1.73m²) with diabetes mellitus and CKD (on diabetes therapy). Dose: dasatinib 100 mg/day + quercetin 1000 mg/day (500 mg twice daily) for 3 consecutive days (Days 1–3). Abdominal subcutaneous adipose tissue biopsies collected at Day 0 (baseline) and Day 14 (11 days after completing the 3-day course). Demonstrated: p16INK4A+ cells reduced 35% (p=0.001); p21CIP1+ cells reduced 17% (p=0.009); SA-βgal+ cells reduced 62% (p=0.005); CD68+ macrophages per adipocyte reduced 28% (p<0.0001); crown-like structures reduced significantly (p=0.001). Skin biopsies from the overlying epidermal layer also showed reductions in p16INK4A+ and p21CIP1+ cells. Circulating SASP factors (IL-1α, IL-6, MMPs-9 and -12) significantly lower at Day 14. Adipocyte progenitor cell density/time in culture was 8% greater in post-treatment vs. pre-treatment biopsies from the same subjects (p=0.027; N=11; MTS proliferation assay over 3 passages). First direct tissue-level evidence that senolytics reduce senescent cells in living humans. Sample size is very small; no control arm; not powered for clinical outcomes.

### Phase 2 RCT — postmenopausal women, bone metabolism (Farr 2024) [^farr2024]

The first placebo-controlled D+Q senolytic RCT to publish results. Open-label (not double-blind) design. Sixty (n=60) postmenopausal women (age 60–90) randomized to intermittent D+Q vs placebo: D 100 mg/day × **2 consecutive days**, Q 1,000 mg/day (250 mg ×4) × **3 consecutive days**, every 28 days × **5 cycles** (20 weeks total). **Primary endpoint MISSED**: percentage change at 20 weeks in CTx (bone resorption marker) — D+Q −4.1% (IQR −13.2, 2.6) vs control −7.7% (IQR −20.1, 14.3); p=0.611. P1NP (bone formation) increased significantly at 2 weeks (+16%, p=0.020) and 4 weeks (+16%, p=0.024) but returned to NS at 20 weeks (−9%, p=0.149). **Circulating SASP:** 36 SASP factors measured at baseline and 2 weeks post-dosing — no significant D+Q vs control difference in any group, including the high-senescent-burden tertile. **Exploratory** finding: women in the highest tertile for T-cell p16 mRNA variant 5 (n≈10/arm) showed concomitant P1NP +34% (p=0.035), CTx −11% (p=0.049) at 2 weeks and radius BMD +2.7% (p=0.004) at 20 weeks. No serious adverse events. Trial: NCT04313634.
...
**Preclinical CNS safety signal (Lombardo 2026 PNAS) [^lombardo2026]:** Healthy young and aged C57BL/6J mice given D 5 mg/kg + Q 50 mg/kg for six oral doses across four weeks developed thinner myelin in the rostral corpus callosum without detected oligodendrocyte loss. The displayed TEM experiment used three mice/group and tested nested axons rather than reporting a mouse-level effect estimate. In primary rat cultures, dasatinib, quercetin, and D+Q each rapidly retracted mature-oligodendrocyte processes; D+Q also impaired OPC differentiation. Transcriptomics and ATF4/XBP1 staining associated these effects with an [[unfolded-protein-response]]-related signature, but no rescue proved that mechanism. There were no single-drug in-vivo arms and no brain senescence-burden or target-engagement assay, so dasatinib-specific attribution and senolysis causality are unresolved. This is a D+Q-regimen safety signal, not a demonstrated senolytic-class effect or a human risk estimate. #gap/needs-replication #gap/needs-human-replication #gap/no-mechanism #gap/long-term-unknown
...
[^lombardo2026]: [[studies/lombardo-2026-senolytic-demyelination]] · displayed TEM n=3 mice/age/treatment group; 1,500–2,000 nested axons/group · in-vivo (young and aged C57BL/6J mouse) + in-vitro (primary rat oligodendrocyte lineage) · D 5 mg/kg + Q 50 mg/kg oral gavage, six doses over four weeks · regional myelin thinning/loss and nonlethal oligodendrocyte dysfunction; no in-vivo monotherapy or senolytic target-engagement test · doi:10.1073/pnas.2524897123 · PMID 41843680
