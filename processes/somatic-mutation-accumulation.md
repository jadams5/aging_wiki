...
| Normal bronchial epithelium | ~22 SNVs/cell/year (never-smokers); **+2,330 (ex) / +5,300 (current smokers)** excess SNVs/cell | Yoshida 2020 [^yoshida2020]; WGS of single-cell-derived colonies. The clearest normal-tissue **exogenous-mutagen** dose effect — though *categorical* only (no significant per-cig/day or per-duration slope; underpowered, n=3 current smokers). Ex-smokers carry a 4× enrichment of near-normal-burden cells: cessation lets a **shielded quiescent stem-cell pool repopulate** and dilute the damaged fraction — the damaged cells retain their full load (irreversible accrual), so the lower ex-smoker average is dilution, **not mutation repair** |
...
[^yoshida2020]: [[studies/yoshida-2020-bronchial-epithelium-mutations]] · doi:10.1038/s41586-020-1961-1 · PMID 31996850 · PMC7021511 (OA) · Yoshida et al. · *Nature* 2020 · 16 subjects (never/ex/current smokers + children); single-cell-derived colony WGS · observational · model: human normal bronchial basal cells · ~22 SNVs/cell/year endogenous; ex-smoker +2,330, current-smoker +5,300 excess SNVs/cell (categorical; no significant per-pack-year slope) · two-compartment model: heavily-exposed proliferative progenitors replenished from a largely-shielded quiescent stem-cell pool; on cessation the quiescent pool repopulates and dilutes the damaged fraction (damaged cells retain their load — NOT repair) · see study page for full verified detail
