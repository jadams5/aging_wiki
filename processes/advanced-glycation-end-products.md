...
> ⚠️ Auto-extracted by Claude on 2026-05-09; expanded 2026-05-15 with web-research additions and 2026-07-14 with a full-text-checked CMLase update. The CMLase claims were verified against the primary paper and supplement, but this broad page has not received an end-to-end verifier pass. Verify older quantitative claims (n's, doses, p-values, endpoints) against primary sources before relying on them.
...
**Stage 3 — Late (physiologically persistent): AGE formation**
Amadori products undergo further oxidative and non-oxidative rearrangements, dehydration, and fragmentation to generate highly reactive α-oxoaldehyde intermediates (3-deoxyglucosone, methylglyoxal, glyoxal) and then stable, often fluorescent or crosslinking AGE adducts. These products are generally persistent because no endogenous mammalian enzyme is known to repair them and long-lived proteins turn over slowly. An engineered enzyme now proves that one mature monovalent adduct, [[carboxymethyl-lysine|CML]], can be converted back to lysine ex vivo; this does not establish physiological repair or cleavage of bifunctional crosslinks such as glucosepane.[^trabosh2026] The reaction is also **concentration-dependent on glucose**, explaining why hyperglycemia in diabetes dramatically accelerates accumulation [^uceda2024].
...
| **[[carboxymethyl-lysine|CML]]** (Nε-carboxymethyl-lysine) | Non-crosslink adduct | Oxidative; glycoxidation product | Abundant; serum marker; engineered ex-vivo repair demonstrated |
...
The "broad-spectrum AGE breaker / inhibitor" pharmacological hypothesis received substantial clinical setback (alagebrium Phase 3 null in systolic HF; aminoguanidine Phase 3 halted for toxicity; TRC4186 stalled at Phase 1). Compounding this, the **Yang 2003 critique** raises the possibility that the alagebrium-class preclinical functional record may not reflect genuine Maillard-crosslink cleavage. The field has split into substrate-specific repair programs. Revel's CMLase now supplies peer-reviewed proof that engineered enzymes can repair a stable protein-bound AGE adduct, while the defining structural target — glucosepane — still lacks published in-vivo cleavage efficacy.[^trabosh2026] The clinical landscape therefore still has zero validated AGE-crosslink-breaking interventions.
...
**Reproducibility setback and strategic pivot (post-2021).** Industry-watcher reporting indicates that the glucosepane activity of the original enzyme candidates could not be reproduced, prompting Revel to broaden its scope beyond glucosepane.[^revel-fightaging-2024] The claim remains non-primary and should be treated cautiously.

**Peer-reviewed CMLase result (2026).** Trabosh et al. evolved [[cmlase|CMLase (CrGO-897)]] from a bacterial glycine oxidase. The enzyme restored lysine from protein-bound CML, lowered CML at 30/33 mapped sites on model protein, and reduced endogenous CML in single-donor human lens, aorta, and skin samples ex vivo.[^trabosh2026] This is direct mature-adduct target engagement, but not an AGE-crosslink result: CML is monovalent, glucosepane/pentosidine were not cleaved, and no living mammalian system, delivery, safety, signaling, biomechanics, or clinical endpoint was tested. No published in-vivo glucosepane-cleavage efficacy data from any program exists as of 2026-07-14. #gap/needs-human-replication
...
AGE crosslink accumulation (dominated by glucosepane in adult human ECM) is the canonical target of the SENS **GlycoSENS** damage category. Engineered CML repair now validates the general damage-repair concept for one noncrosslink AGE, but no clinical-stage program against the dominant crosslink target exists as of 2026. See [[frameworks/sens-damage-categories]].
...
**Druggability:** null for the broad process. [[carboxymethyl-lysine|CML]] now has a tier-2 biochemical/ex-vivo probe, but broad-spectrum approaches failed clinically and no validated probe cleaves the dominant ECM crosslink glucosepane.
...
- **CMLase translation is untested.** Thin sections and homogenate bypass intact-ECM penetration; immunogenicity, reaction-byproduct safety, in-vivo target engagement, function, and durability remain open. #gap/needs-replication
...
[^uceda2024]: doi:10.1007/s12551-024-01188-4 · Uceda AB, Mariño L, Casasnovas R, Adrover M · *Biophys Rev* 2024;16(2):189–218 · review · comprehensive overview of glycation mechanisms, Maillard reaction biochemistry, AGE species, pathogenesis, and inhibitory strategies
...
[^trabosh2026]: [[studies/trabosh-2026-cmlase-deglycation]] · doi:10.1038/s41467-026-75141-2 · in-vitro + ex-vivo human tissue · seven human donors across figures, but headline older lens/aorta/skin outcomes each use one donor and technical/spatial subsamples · engineered CMLase restored lysine from protein-bound CML · no treatment-comparison p-values; no true-crosslink, living-mammalian, functional, delivery, or safety test · peer-reviewed

[^monnier2014ref]: doi:10.1515/cclm-2013-0174 · Monnier VM, Sun W, Sell DR, Fan X, Nemet I, Genuth S · *Clin Chem Lab Med* 2014;52(1):21–32 · review · glucosepane as "most prevalent AGE and protein crosslink of ECM"; covers glucose/fructose-AGE axis as markers for microvascular disease · PMID:23787467
...
[^guvatova2026]: doi:10.1016/j.arr.2025.102919 · Guvatova ZG, Vakhrusheva A, Moskalev A · *Ageing Res Rev* 2026 · review · RAGE as central link between AGE accumulation ("garb-aging") and inflammaging; covers RAGE structure, ligands, NF-κB signaling, and therapeutic approaches · closed-access

[^granic2023]: doi:10.1016/j.mad.2022.111744 · Granic A, Hurst C, Dismore L, Dodds RM, Witham MD, Robinson SM, Sayer AA · *Mech Ageing Dev* 2023;210 · systematic-review · 15 observational studies (14 cross-sectional, 1 prospective) · SAF and circulating AGEs negatively associated with muscle strength, mass, and physical functioning; AGEs predict walking disability and sarcopenia risk · PMID:36368549
...
[^vlassara2024]: doi:10.1038/s41598-024-71037-7 · [authors pending confirmation] · *Sci Rep* 2024 · observational · population-based cohort · skin autofluorescence associated with cause-specific mortality independent of traditional risk factors

[^sveen2015ref]: doi:10.1016/j.jdiacomp.2014.12.011 · Sveen KA et al. · *J Diabetes Complications* 2015 · observational · n=27 T1D (40-year duration) + 24 controls · skin glucosepane correlated with cIMT (r=0.41) and PWV (r=0.44) independent of HbA1c · closed-access

[^genuth2015ref]: doi:10.2337/db14-0215 · Genuth S, Sun W, Cleary P, Gao X, Sell DR, Lachin J, Monnier VM · *Diabetes* 2015 · observational · n=DCCT/EDIC cohort · 10-AGE panel predicted 3-step ETDRS retinopathy worsening (p≤0.002) independent of HbA1c; per-endpoint attribution corrected R45 (2026-05-20): glucosepane + furosine for retinopathy; [[mg-h1|MG-H1]] + furosine for neuropathy; furosine for nephropathy
...
[^draghici2015ref]: doi:10.1126/science.aac9655 · Draghici C, Wang T, Spiegel DA · *Science* 2015;350(6258):294–8 · in-vitro/synthetic chemistry · first 8-step total synthesis of glucosepane (12% yield, enantioselective) · enabled antibody tools and Revel research program · closed-access · PMID:26472902

[^little2005ref]: doi:10.1016/j.cardfail.2004.09.010 · Little WC, Zile MR, Kitzman DW, Hundley WG, O'Brien TX, Degroof RC · *J Card Fail* 2005 · rct · n=21 · alagebrium 420 mg/day × 16 weeks in elderly diastolic HF · reduced LV mass, improved E' velocity · closed-access
