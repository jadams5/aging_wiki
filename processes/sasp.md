...
- **SASP heterogeneity is under-mapped.** Cell-type- and inducer-specific SASP compositions are described for fibroblasts and epithelial cells but are incomplete for neurons, cardiomyocytes, and tissue-resident immune cells. #gap/needs-replication
