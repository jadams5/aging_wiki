...
- **Stable:** CML does not spontaneously hydrolyze from protein under physiological conditions; it is a permanent modification until the protein is degraded.
...
**CML clearance from established tissue:** No mammalian enzyme cleaves CML from protein. [[fn3k]] acts on fructosyl-lysine (Amadori product, Stage 2), not CML (a downstream product). This is the key limitation: once CML is formed, it is permanent until protein turnover.

**Delanghe 2024 — FAOD reduces CML ex vivo:** Delanghe et al. 2024 reported that FAOD (fructosyl amino oxidase; see [[microbial-amadori-deglycation]]) acts on CML (along with CEL and imidazolone) in glycolaldehyde-treated retinal tissue, as detected by mass spectrometry [^delanghe2024]. If confirmed with full-text verification, this would be the **first natural enzyme reported to act on mature CML**. However: (a) this is abstract-only verification; (b) the study system uses glycolaldehyde-glycated tissue (not naturally accumulated CML from the Maillard pathway); (c) no in-vivo data exist. #gap/needs-replication

## Limitations and gaps

- **No in-vivo human CML-cleavage enzyme exists.** Clearance depends entirely on protein turnover (collagen half-life decades). #gap/no-mechanism for acute CML clearance in ECM.
...
- [[microbial-amadori-deglycation]] — FAOD; only known enzyme with any reported CML activity (Delanghe 2024)
