...
verified-by: claude
verified-scope: "Abstract-level verification of 15 original sources via PubMed/Crossref + Dammann 2012 full-PDF verification (PMC3348492) for cross-species section + Li 2025 abstract verification (Nanoscale Horizons aptamer paper). 2026-07-14 Revel update verified against Trabosh 2026 main PDF and supplement; CMLase explicitly excluded from glucosepane-crosslink evidence. See Verification log section in body for per-source detail and update history."
---
...
**Peer-reviewed Revel result, but on CML rather than glucosepane.** Trabosh et al. 2026 reported [[cmlase|CMLase (CrGO-897)]], an engineered bacterial glycine-oxidase variant that restores lysine from protein-bound [[carboxymethyl-lysine|CML]].[^trabosh2026] It reduced CML at 30/33 mapped sites on model protein and reduced endogenous CML in single-donor human lens, aorta, and skin samples ex vivo. This validates enzyme engineering against a mature AGE adduct, but **does not validate glucosepane cleavage**: CML modifies one lysine and is not a bifunctional crosslink; glucosepane and pentosidine were not tested. No living animal, tissue-mechanics, delivery, or safety experiment was reported.

The Revel program remains preclinical. The official ClinicalTrials.gov search found no active CMLase/CrGO-897 study, and **no published in-vivo glucosepane-cleavage efficacy data exists from any program as of 2026-07-14.** #gap/needs-human-replication #gap/needs-primary-source-verification (the older reproducibility-setback statement is sourced to a Fight Aging blog comment, not peer-reviewed literature or an official Revel disclosure).
...
**No clinically deployed glucosepane-cleaving intervention exists as of 2026-07-14.**
...
- **CMLase does not close the glucosepane gap.** It proves mature CML repair ex vivo, but glucosepane substrate recognition, cleavage chemistry, intact-ECM access, and functional rescue remain untested. #gap/no-mechanism
...
**2026-05-09 — initial verification pass (claude):** Abstract-level verification via PubMed/Crossref for all 14 original sources. Full text was unavailable for several papers at the time. Voziyan 2026 was verified against the PubMed abstract. Key quantitative claims corrected against source abstracts: Sell 2005 n, units, tissue scope; Hartog 2011 primary endpoint p-value; Monnier 2022 specimen type and p-values. The ~10–100× pentosidine ratio is flagged as derived from review synthesis rather than directly stated in the Sell 2005 abstract. Full-PDF verification still required for: Sell 2005 full ratio table, Genuth 2015 n per complications arm, Gautieri 2014 14-pairs claim, Bakris 2004 Phase 2 trial details, and Sjöberg 2009 alagebrium mechanistic-critique claim.
...
**2026-07-14 — Revel/CMLase boundary update (codex):** Trabosh 2026 main paper and supplement read end-to-end. Added the peer-reviewed CMLase result while preserving the central negative conclusion: protein-bound CML repair is mature-adduct deglycation, not glucosepane or pentosidine cleavage. Human lens/aorta/skin results are single-donor ex-vivo target engagement; no in-vivo or functional crosslink result.

---

## Footnotes

[^sell2005]: doi:10.1074/jbc.M500733200 · Sell DR, Biemel KM, Reihl O, Lederer MO, Strauch CM, Monnier VM · *J Biol Chem* 2005 Apr 1;280(13):12310–15 · ex-vivo · model: human skin collagen (n=110) + glomerular basement membrane collagen (n=28) · foundational quantification showing glucosepane is the dominant AGE crosslink; at age 90, ~2000 pmol/mg skin collagen (nondiabetic) rising to ~5000 pmol/mg in diabetes (p<0.0001); accounts for up to >120 mol% triple-helical collagen modification in diabetes; ~10–100× ratio vs pentosidine is cited in review literature based on comparison with prior pentosidine measurements · PMID:15677467

[^sjöberg2009]: doi:10.1089/rej.2009.0846 · Sjöberg JS, Bulterijs S · *Rejuvenation Res* 2009 · review · model: human ECM biochemistry · comprehensive mechanistic and pathophysiology review; covers formation, structure, and non-oxidative pathway; includes discussion of alagebrium mechanistic-target mismatch · closed-access

[^monnier2005]: doi:10.1196/annals.1333.061 · Monnier VM, Mustata GT, Biemel KL, Reihl O, Lederer MO, Zhenyu D, Sell DR · *Ann NY Acad Sci* 2005 Jun;1043:533–44 · review · identifies glucosepane as "the single most important collagen cross-link known to date in diabetes and aging"; confirms nonoxidative formation pathway · closed-access · PMID:16037276

[^monnier2014]: doi:10.1515/cclm-2013-0174 · Monnier VM, Sun W, Sell DR, Fan X, Nemet I, Genuth S · *Clin Chem Lab Med* 2014 Jan 1;52(1):21–32 · review · confirms glucosepane as "the most prevalent AGE and protein crosslink of the extracellular matrix"; covers glucose/fructose-lysine/glucosepane AGE axis as most robust marker for microvascular disease especially retinopathy; framed as "call for data" in an understudied field · PMID:23787467 · PMCID:PMC6557662

[^draghici2015]: doi:10.1126/science.aac9655 · Draghici C, Wang T, Spiegel DA · *Science* 2015 Oct 16;350(6258):294–8 · in-vitro / synthetic chemistry · first concise 8-step total synthesis of glucosepane (12% overall yield, enantioselective, convergent); enabled synthesis of immunogens and antibody tool reagents · closed-access · PMID:26472902
...
[^sveen2015]: doi:10.1016/j.jdiacomp.2014.12.011 · Sveen KA et al. · *J Diabetes Complications* 2015 · observational · n=27 T1D (40-year duration) + 24 controls · glucosepane in skin collagen correlated with cIMT (r=0.41) and PWV (r=0.44) · closed-access
...
[^genuth2015]: doi:10.2337/db14-0215 · Genuth S, Sun W, Cleary P, Gao X, Sell DR, Lachin J, Monnier VM · *Diabetes* 2015 · observational · n=DCCT/EDIC cohort · skin glucosepane and MG-H1 independently associated with retinopathy progression (p≤0.002 for 10-AGE panel) independent of HbA1c
...
[^little2005]: doi:10.1016/j.cardfail.2004.09.010 · Little WC, Zile MR, Kitzman DW, Hundley WG, O'Brien TX, Degroof RC · *J Card Fail* 2005 · rct · n=21 · alagebrium 420 mg/day × 16 weeks in elderly diastolic HF patients; reduced LV mass, improved E' velocity; no change in EF or arterial compliance · closed-access
