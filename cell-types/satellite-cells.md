...
#### Senolytics and the growth/regeneration response (load-induced senescence)

A distinct axis from clearing *resting* aged-niche senescent cells: the **hypertrophic/regenerative stimulus itself induces senescent cells**, which then repress the satellite-cell response — most consequentially in aged muscle that cannot clear them.

- Senescent cells are integral, regeneration-repressing components of the muscle niche **at all ages**; they build an aged-like inflamed (inflammageing-mirroring) niche that arrests satellite-cell proliferation. Reducing their burden — or neutralizing their CD36-dependent inflammatory secretome — accelerates regeneration in **both young and old** mice, while transplanting senescent cells *delays* it [^moiseeva2023].
- Senescent cells (SA-β-Gal + p21) are nearly absent in resting muscle but **emerge ~2 weeks after a single bout of resistance exercise in humans** and during mechanical overload in mice; aged mice accumulate more than young and have blunted hypertrophy, which a hit-and-run D+Q course rescued [^dungan2022]. See [[studies/dungan-2022-senolytic-muscle-hypertrophy]] and [[studies/moiseeva-2023-senescence-atlas-muscle-regeneration]].
- **Caution / age-specificity:** the benefit is shown in aged, clearance-impaired muscle. In young muscle these transient p21+ cells are plausibly part of normal remodeling, and indiscriminate senolysis during training is untested (possibly counterproductive). Exercise is itself partly senomorphic. No human senolytic + resistance-training trial exists. #gap/needs-human-replication
