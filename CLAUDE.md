...
- `sops/personal-tracking-oura-example.md` — optional, privacy-safe Oura API V2 worked example (OAuth, endpoint-to-CSV mapping, validation, agent handoff); not a wearable requirement or canonical vendor dependency
