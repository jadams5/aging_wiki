---
type: intervention
aliases: [MedDiet, Mediterranean dietary pattern, MedDiet+EVOO, MedDiet+nuts]
mode: dietary
mechanisms: [dietary-fat-composition, mufa-enrichment, pufa-omega3-enrichment, anti-inflammatory, gut-microbiome-modulation, nf-kb-inhibition]
targets: []
target-hallmarks: ["[[chronic-inflammation]]", "[[deregulated-nutrient-sensing]]", "[[altered-intercellular-communication]]", "[[disabled-macroautophagy]]", "[[dysbiosis]]", "[[cellular-senescence]]"]
target-pathways: ["[[nf-kb]]", "[[nlrp3-inflammasome]]", "[[mtor]]", "[[ampk]]", "[[insulin-igf1]]"]
human-evidence-level: strong
clinical-stage: implemented
safety-profile: well-established
translation-gap: human-evidence-strong
next-experiment: "MedDiet vs. isocaloric MedDiet-with-SFA-floor (SFA <7% kcal via further EVOO/fish displacement of remaining SFA) head-to-head RCT: does dropping SFA below 7% kcal in a pre-existing high-MUFA Mediterranean pattern yield incremental CV or epigenetic-aging benefit, or does the CORDIOPREV result saturate at the MUFA/PUFA ratio already achieved by standard MedDiet (~22% MUFA / 8% SFA)?"
clinical-trials-active: 325
literature-checked-through: 2026-05-09
verified: true
verified-date: 2026-05-09
verified-by: claude
verified-scope: "PREDIMED 2018 (doi:10.1056/NEJMoa1800389) verified against full PDF — exact HR+CI added, site count corrected (57 centres→11 sites/169 clinics), age range corrected (55-80 all→men 55-80/women 60-80), EVOO dose specified (50 g/day), nut composition specified. CORDIOPREV 2022 (doi:10.1016/S0140-6736(22)00122-2) not_oa — HR range, n, event counts, p-value verified against PubMed abstract (PMID 35525255); HR corrected (single ~0.74→range 0.719-0.753). Lyon 1999 (doi:10.1161/01.cir.99.6.779) not_oa — risk ratio range and 3-CO event counts verified against PubMed abstract (PMID 9989963); risk ratio corrected (0.27-0.30→0.28-0.53 across 3 COs). Bozack 2025 (doi:10.1038/s41514-025-00298-x) verified against full PDF — PhenoAge coefficient corrected (−1.02→−1.05 yr, CI −1.87 to −0.22 added), clock count corrected (5→11 measures), DunedinPACE→DunedinPoAm, MiAge removed (not in paper). Kasiri 2024 first-author corrected (Kasiri→Tran), footnote tag renamed. Nucci 2026 DOI (10.1016/j.nut.2026.113189), PMID (41930792), and exact RR 0.96 (0.95-0.97) added. clinical-trials-active corrected (4→325 per ClinicalTrials.gov v2 countTotal query). PREDIMED-NAVARRA telomere substudy and García-Calzón 2016 footnote not re-verified (PDF not downloaded; claims appropriately tagged as observational). Oleocanthal/mechanistic sources not re-verified. The vegetarian/vegan comparison row added 2026-07-15 was cross-checked against the scoped-verified vegetarian-diet page."
---
...
The original 2013 NEJM paper (Estruch et al. 2013, doi:10.1056/NEJMoa1200303 — **RETRACTED**) [^predimed2013retracted] reported a significant primary endpoint reduction (major CV event HR ~0.70 for MedDiet+EVOO, ~0.72 for MedDiet+nuts vs control; ~30% relative risk reduction). The trial was halted early (~4.8 yr median) for efficacy.
...
Estruch et al. 2018, *New England Journal of Medicine* — **doi:10.1056/NEJMoa1800389** [^predimed2018] — the **active citation for PREDIMED claims**.
...
#gap/needs-replication — CORDIOPREV was a single-centre Spanish trial; generalizability to non-Mediterranean populations with different baseline diets requires confirmation.

### Lyon Diet Heart Study — historical secondary prevention (1994/1999)

**Lyon Diet Heart Study** by de Lorgeril et al. randomized 605 post-MI patients to a Mediterranean-inspired diet supplemented with an ALA-rich rapeseed (canola) oil margarine (to boost omega-3 ALA without requiring fish oil) versus a "prudent" Western control diet [^lyon1999]. Mean follow-up ~46 months.
...
**Bozack et al. 2025 (npj Aging; n=1,771 NHANES adults, complete-case primary analysis)** examined dietary fatty acid intakes against eleven epigenetic age-acceleration measures (Horvath1, Horvath2, Hannum, Lin, Zhang, Vidal-Bralo, PhenoAge, GrimAge2, DNAmTL, epiTOC, DunedinPoAm) using NHANES 1999–2002 data [^bozack2025].
...
**Yubero-Serrano et al. 2024** (CORDIOPREV sub-study, n=809; the 5-year MG/GLO1 readout from the main CORDIOPREV cohort) reported that the Mediterranean-diet arm maintained stable [[methylglyoxal]] plasma levels over 5 years while the low-fat arm showed increased MG; [[glo1|GloxI]] (GLO1) **mRNA** upregulation in the MedDiet arm correlated with reduced atherosclerosis progression in the post-hoc "non-worsening IMT" subgroup [^cordioprev2024age]. This is the first long-duration (5-yr) human RCT evidence for dietary GLO1 induction — earlier evidence was confined to 8-week isolated-polyphenol trials (Rabbani 2021 trans-resveratrol + hesperetin). Caveats: GLO1 measured at mRNA level only (no protein expression or enzyme activity confirmation); the IMT–GLO1 correlation was assessed in a post-hoc subgroup; CORDIOPREV is single-centre Spanish post-CHD only. See [[studies/cordioprev-2024-meddiet-glo1]] for full quantitative detail. #gap/needs-replication

### Telomere length — PREDIMED-NAVARRA substudy

A substudy of the PREDIMED-NAVARRA cohort (García-Calzón et al. 2016, Clinical Nutrition; doi:10.1016/j.clnu.2016.03.013) found that higher adherence to the Mediterranean diet was associated with longer telomeres in high-cardiovascular-risk subjects [^predimadnavarra2016]. Association was cross-sectional + prospective within the trial period. Effect magnitude and significance not extracted (primary source PDF not downloaded). #gap/needs-replication — single cohort; no other MedDiet RCT has measured telomere length as a pre-specified endpoint.
...
#gap/needs-replication — ALA-to-EPA/DHA conversion efficiency in humans is low (~5–10%) and variable; walnut-derived ALA may not fully substitute for preformed EPA/DHA from fish in metabolically healthy vs. insulin-resistant individuals.
...
| [[cellular-senescence]] | Palmitate reduction avoids p16+/p21+ endothelial senescence induction | Mechanistic (in-vitro) #gap/needs-human-replication |
...
**hsCRP and inflammatory markers (umbrella review):** An umbrella review of dietary-pattern meta-analyses on CRP (Tran et al. 2024, British Journal of Nutrition, doi:10.1017/S0007114524001648) found the Mediterranean diet among the most consistently CRP-reducing dietary patterns across interventional and observational meta-analyses, with moderate-to-strong evidence classification [^tran2024].

**Mortality meta-analysis (2026):** Nucci et al. 2026 (*Nutrition*, doi:10.1016/j.nut.2026.113189; PMID 41930792) performed a systematic review and meta-analysis of 54 cohort studies (1,833,267 participants; 346,034 deaths) within the Italian national dietary guidelines synthesis, finding pooled RR for all-cause mortality of **0.96 (95% CI 0.95–0.97)** per 1-point increase in Mediterranean diet adherence score (moderate certainty evidence, NUTRIGRADE) [^nucci2026]. This is post-PREDIMED/CORDIOPREV, cross-validating the primary-prevention endpoint in broader observational literature. #gap/needs-replication — meta-analyses of Mediterranean diet and mortality are observational; RCT-level mortality data remain confined to PREDIMED and CORDIOPREV (CV mortality only, not all-cause).
...
**Practical interpretation:** The Mediterranean dietary pattern can be implemented **alcohol-free** without losing its primary mechanistic benefits (EVOO, vegetables, legumes, fish, nuts are the active components; wine contributes only at the margins). For patients abstaining from alcohol, the pattern should be framed accordingly. #gap/contradictory-evidence — whether wine-inclusive vs wine-free MedDiet has different endpoint outcomes has not been tested in a head-to-head RCT arm.
...
| **Vegetarian / vegan** | [[vegetarian-diet|Direct RCTs are surrogate-only; no mortality-powered comparison with an optimized omnivorous diet]] | Limited | Meat exclusion; effect depends strongly on replacement foods and overall pattern quality |
...
#gap/contradictory-evidence — The MIND trial 2023 (JAMA, n=604, 3 yr) did not show significant cognitive benefit of MIND vs. DASH in older adults at risk for Alzheimer's, partially contradicting earlier observational data. This is a caution against over-extending MedDiet/MIND claims into cognitive endpoints.
