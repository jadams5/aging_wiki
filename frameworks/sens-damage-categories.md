...
**Repair strategy:** AGE-breaker compounds (the alagebrium / ALT-711 class — failed Phase 3); engineered enzymatic damage repair (Revel Pharmaceuticals has demonstrated ex-vivo repair of CML, a noncrosslink AGE adduct); true glucosepane cleavage remains preclinical and undemonstrated in vivo; aldehyde-trapping / glyoxal-scavenging agents act upstream rather than repairing established damage.
...
- **Revel Pharmaceuticals engineered AGE-repair pipeline** — founded 2018; built on the Yale glucosepane chemistry program. Trabosh et al. 2026 now provides the first peer-reviewed candidate from the broadened platform: [[cmlase|CMLase (CrGO-897)]] directly restores lysine from protein-bound [[carboxymethyl-lysine|CML]] and reduced endogenous CML in single-donor human lens, aorta, and skin samples ex vivo. **Boundary:** CML is monovalent, not a crosslink; glucosepane/pentosidine cleavage, living-animal delivery, safety, and functional rescue were not shown. The earlier reported glucosepane-enzyme reproducibility setback remains industry-watcher-grade. No active CMLase trial or peer-reviewed animal-efficacy result was found as of 2026-07-14. See [[processes/glucosepane]], [[advanced-glycation-end-products]], and [[age-crosslink-breakers]]. #gap/needs-primary-source-verification on the older setback claim.
...
**Highest-priority recent finding:** CMLase establishes peer-reviewed enzymatic repair of a mature protein-bound AGE adduct in aged human tissue ex vivo. It materially validates GlycoSENS-style repair at the adduct level, while leaving the category's defining ECM-crosslink problem — glucosepane cleavage with functional recovery in vivo — unresolved.
